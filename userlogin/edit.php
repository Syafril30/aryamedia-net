  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <h2 class="center text-gray-800">Data User</h2>
	...
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from user_login where id='$id'");
                    ...
                    <form method="post" action="update.php">
                      <div class="modal-body">
                        ...
                        <input type="hidden" id="form3" class="form-control validate" name="id" value="<?php echo $d['id']; ?>">
                          <input type="text" id="form3" class="form-control validate" name="name" value="<?php echo $d['name']; ?>">
                         
                        </div>
                
                        <div class="md-form ">
                        <label data-error="wrong" data-success="right" for="form3">PPPoE</label>
                          <input type="text" id="form3" class="form-control validate" name="pppoe" value="<?php echo $d['pppoe']; ?>">
                         
                        </div>
                        <div class="md-form ">
                        <label data-error="wrong" data-success="right" for="form3">Password</label>
                          <input type="text" id="form3" class="form-control validate" name="pass" value="<?php echo $d['pass']; ?>">
